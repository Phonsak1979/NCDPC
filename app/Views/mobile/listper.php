...
<div class="container-fluid p-0">
    ...
    <div class="menu-grid">
        ...
        <a href="<?= base_url('public/vitals/').$risk['hospcode'].'/'.$risk['pid'] ?>" class="menu-card <?= strtolower($risk['risktype']) === 'dm' ? 'risk-dm' : 'risk-ht' ?>">
            <div>
                <img src='<?= base_url($risk['sex'] == 1 ? 'images/man.png' : 'images/woman.png') ?>' width='80'
                    height='80' alt=''>
            </div>
            <div class="pname"><?= $risk['pname'] ?></div>
            <div class="pname"><?= $risk['age'] ?> ปี</div>
            <div class="risktype"><?= $risk['result1'] ?></div>
            <div class="btn-vitals"></div>
        </a>
