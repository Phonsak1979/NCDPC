    ...
    <div class="header-section">
        <div class="header-content">
            ...
            <div class="header-text">
                <h2>คลังความรอบรู้</h2>
                <h4>สื่อสุขภาพ(Health Lieteracy)</h4>
            </div>
            <img src="<?=base_url('images/pcc.jpg')?>" class="header-logo" alt="PCC Logo">
        </div>
    </div>
    <div class="menu-grid">
      <?php if(!empty($videoname)): foreach($videoname as $video): ?> 
        <a href="<?=base_url('public/viewVideo/'.$video['str_url'].'')?>" class="menu-card">
            <img src="<?=base_url('uploads/vdo/'.$video['str_img'].'')?>" alt="<?= $video['descript']; ?>">
            <div class="card-body">
