...
<div class="container-fluid p-0">
    ...
    <div class="menu-grid">
        ...
        <a href="<?= base_url('public/mobile/hl_survay/').$id ?>" class="menu-card">
            <div>
                <img src='<?= base_url("") ?>' width='80' height='80' alt=''>
            </div>
            <div class="pname">สำรวจความตระหนักรู้</div>
            <div class="btn-vitals"></div>
        </a>

         <a href="<?= base_url('public/mobile/HealthLit-page/').$id ?>" class="menu-card">
            <div>
                <img src='<?= base_url("") ?>' width='80' height='80' alt=''>
            </div>
            <div class="pname">บันทึกผลการตรวจสุขภาพ</div>
            <div class="btn-vitals"></div>
        </a>
    </div>
