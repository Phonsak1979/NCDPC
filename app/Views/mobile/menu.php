...
<div class="container-fluid p-0">
    ...
    <div class="menu-grid">
        <a href="<?=base_url('public/mobile/riskList')?>" class="menu-card">
        ...
        <a href="<?=base_url('public/health-literacy')?>" class="menu-card">
            <img src="<?=base_url('images/hl_logo.jpg')?>" alt="ความรอบรู้ด้านสุขภาพ">
            <div class="card-body">
                <div class="h6">ระดับความรอบรู้ด้านสุขภาพ</div>
            </div>
        </a>
        ...
        <a href="<?= base_url('public/mobile/HealthLit-page'); ?>" class="menu-card">
    ...
    <div id="nav">
        <div class="nav-container">
            <div class="user-info">
                ...
                <span><?= esc($hcoachname);?><br></span>
            </div>
            <a href="<?=base_url('public/mb-logout')?>" class="logout-btn">
