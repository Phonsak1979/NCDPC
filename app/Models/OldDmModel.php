...
class OldDmModel extends Model
{
    protected $table            = 'olddm';
    ...
    public function getPatientByOrgan_chart($hcode = null)
    {
        $builder1 = $this->db->table($this->table);
        $builder2 = $this->db->table('oldht');
        ...
        return $builder1->unionAll($builder2)->get()->getResultArray();
    }
}
